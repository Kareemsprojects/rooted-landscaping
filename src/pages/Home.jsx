  ...
  return (
    <>
      <section className="hero" id="top">
        {/* PLACEHOLDER: swap for <video autoPlay muted loop playsInline> drone hero footage */}
        <Placeholder label="HERO VIDEO PLACEHOLDER<br>(drone footage — pending)" />
      ...
      <section className="section-pad home-gallery-preview">
        ...
        <div className="container">
          <div className="work-grid">
            {/* PLACEHOLDER: replace each with real project photos */}
            <Placeholder className="work-cell tall" label="Photo placeholder<br>Hardscaping" />
            <Placeholder className="work-cell" label="Photo placeholder<br>Lawn Care" />
            <Placeholder className="work-cell" label="Photo placeholder<br>Design" />
            <Placeholder className="work-cell" label="Photo placeholder<br>Planting" />
            <Placeholder className="work-cell" label="Photo placeholder<br>Seasonal" />
          </div>
          <div style={{ textAlign: 'center', marginTop: '48px' }}>
